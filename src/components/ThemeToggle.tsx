...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <div
        className="relative w-4 h-4 transform-style-preserve-3d transition-transform duration-1000 ease-in-out
    dark:rotate-y-180"
      >
        <div
          className="absolute inset-0 backface-hidden transition-opacity duration-1000
        dark:opacity-0"
        >
          <svg
            width="16"
        ...
        <div
          className="absolute inset-0 rotate-y-180 transition-opacity duration-1000
